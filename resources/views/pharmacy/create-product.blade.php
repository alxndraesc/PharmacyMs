...
<div class="container">
    ...
    <div class="card mb-3" style="border: 1px solid #7daaa5;">
        <div class="card-body">
            <form method="POST" action="{{ route('pharmacy.storeProduct') }}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="price_bought" name="price_bought" step="0.01" value="{{ old('price_bought') }}" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="age_group" name="age_group" required>
                                ...
                                <option value="Children" {{ old('age_group') == 'Children' ? 'selected' : '' }}>Children</option>
                                ...
                                <option value="General" {{ old('age_group') == 'General' ? 'selected' : '' }}>General</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12 mb-3">
                        <div class="form-group">
                            <label for="over_the_counter">Over the Counter</label>
                                ...
                                {{ old('over_the_counter') ? 'checked' : '' }}>
                            <small class="text-muted">Check if this product is available over the counter.</small>
                        </div>
                    </div>
                </div>

                <button type="submit" class="btn" style="background-color: #7daaa5; color: white;">Add Product</button>
            </form>
        </div>
    </div>
</div>
